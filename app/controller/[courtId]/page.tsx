...
export default function ControllerPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      unsub2 = onValue(ref(db, META_NAME_PATH), (snap) => setExternalCourtName(typeof snap.val() === "string" ? snap.val() : ""));
    })();
  ...
  return (
    <div className="wrap">
      <style>{`
        ...
        .card{ background:var(--ink2); border:1px solid rgba(0,0,0,.15); border-radius:16px; padding:1.25rem; box-shadow:0 6px 20px rgba(0,0,0,.25); }
        ...
        .pane{ background:rgba(33,42,49,.45); border:1px solid rgba(211,217,212,.12); border-radius:12px; padding:1rem; }
            ...
            <div className="pane">
              <div style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:".75rem"}}>
                <div>
                  ...
                  <input className="input" placeholder="Enter Name" value={s.players["1a"].name}
                ...
                <div>
                  ...
                  <input className="input" placeholder="Enter Name" value={s.players["1b"].name}
            ...
            <div className="pane">
              <div style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:".75rem"}}>
                <div>
                  ...
                  <input className="input" placeholder="Enter Name" value={s.players["2a"].name}
                ...
                <div>
                  ...
                  <input className="input" placeholder="Enter Name" value={s.players["2b"].name}
