...
/** ---------- Helpers / Defaults (kept to match your current UI) ---------- */
...
export default function ControllerCourt1() {
  ...
  return (
    <div className="pageWrap" style={{ background: "var(--c-ink)", minHeight: "100vh" }}>
      <style>{`
        ...
        .bestOfSelect option{ color: #0b1419; }
      `}</style>
      ...
      <div className="container" style={{ width: "min(1200px, 95vw)", paddingTop: 18, paddingBottom: 24 }}>
        <div className="card cardRoot">
          <div className="headerBar" style={{ justifyContent: "space-between", alignItems: "end" }}>
            <div className="courtName">{externalCourtName || "Centre Court"}</div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: ".75rem" }}>
                  <div className="stack" style={{ gap: ".4rem" }}>
                    ...
                    <input
                      ...
                      onChange={(e) => updatePlayer("1a", "name", e.target.value.slice(0, 30))}
                    />
                    <input
                      className="input"
                  ...
                  <div className="stack" style={{ gap: ".4rem" }}>
                    ...
                    <input
                      ...
                      onChange={(e) => updatePlayer("1b", "name", e.target.value.slice(0, 30))}
                    />
                    <input
                      className="input"
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: ".75rem" }}>
                  <div className="stack" style={{ gap: ".4rem" }}>
                    ...
                    <input
                      ...
                      onChange={(e) => updatePlayer("2a", "name", e.target.value.slice(0, 30))}
                    />
                    <input
                      className="input"
                  ...
                  <div className="stack" style={{ gap: ".4rem" }}>
                    ...
                    <input
                      ...
                      onChange={(e) => updatePlayer("2b", "name", e.target.value.slice(0, 30))}
                    />
                    <input
                      className="input"
