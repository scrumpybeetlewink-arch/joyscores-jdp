...
import { ref, onValue, update, type DatabaseReference } from "firebase/database";
...
type ScoreState = {
  meta: { name: string; bestOf: BestOf }; // ← no goldenPoint
...
export default function LivePage() {
  ...
  useEffect(() => {
    ...
    const off = onValue(
      courtRef,
      async (snap) => {
        // one-time cleanup in viewer too
